...
class FirebaseAuthProvider implements AuthProvider {
  ...
  AuthUser? get currentUser {
    ...
    if (user != null) {
      return AuthUser.fromFirebase(user); //if there is a firebase user,
      //we create an auth user out of that and we return it
    } else {
      return null;
    }
  }
  ...
  @override
  Future<void> sendEmailAuthProvider()async {
  final user = FirebaseAuth.instance.currentUser;
  if (user != null) {
